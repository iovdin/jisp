(function() {
  ...
  exports.OptionParser = (OptionParser = (function() {
    ...
    OptionParser.prototype.parse = (function(args) {
      var options, skippingArgument, originalArgs, i, arg, pos, isOption, seenNonOptionArg, matchedRule, rule, value, _ref, _len, _i, _ref0, _len0;
      options = {
        arguments: []
      };
    ...
    OptionParser.prototype.help = (function() {
      var lines, rule, spaces, letPart, _i, _ref, _len;
      lines = [];
  ...
  function buildRules(rules) {
    var tuple, _i, _res, _ref, _len, _ref0;
    _res = [];
    _ref = rules;
    for (_i = 0, _len = _ref.length; _i < _len; ++_i) {
      tuple = _ref[_i];
  ...
  function normaliseArguments(args) {
    var result, arg, match, l, _i, _ref, _len, _i0, _ref0, _len0;
    args = args.slice(0);
    result = [];
    _ref = args;
    for (_i = 0, _len = _ref.length; _i < _len; ++_i) {
